...
<article class='relative flex flex-col items-center p-2 mx-auto prose max-w-prose'>
  ...
  <section id='header' class='flex flex-col items-start justify-start mt-12'>
    <img class='rounded-2xl' src={cover} alt={title}/>
